...
public class FirstTest {
    ...
    public void loginLogOut() throws InterruptedException {
        ...
        this.driver.findElement(email_login).sendKeys("jonathansonkoue75@gmail.com");
...
//        this.driver.findElement(logOut).click();
    ...
    public void register() {
        ...
        this.driver.findElement(email_register).sendKeys("jonathansonkoue75@gmail.com");
        this.driver.findElement(password_register).sendKeys("12345678");
        this.driver.findElement(confirm_password).sendKeys("12345678");
